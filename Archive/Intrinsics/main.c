...
void Mu(int32_t *b, int32_t *q, int32_t *mu) {
    for (int i = 0; i < 4; i++) {
        ...
        double shifted_value = (double)b[i] * (1LL << 31); // Cast to double after shifting to avoid overflow
...
int main () {
    ...
    int32_t mu[4] = {463032,463174,477418,48459784}; 
    int32_t r[4] = {0}; 
    ...
    printf("\n Here we test with NEON intrinsics\n");
